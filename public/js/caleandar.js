...
function createCalendar(calendar, element, adjuster) {
  ...
  function AddDays() {
    ...
    function DayNumber(n) {
      ...
      number.addEventListener('click', calendarDayClickEvent);
    ...
    for (var i = 0; i < calendar.Selected.Days; i++) {
      ...
      var completeDay = new Date(calendar.Selected.Year, calendar.Selected.Month, (i + 1));
      var completeDayFormat = document.createElement('span');
      completeDayFormat.className = 'completeDayFormat';
      // completeDayFormat.innerHTML = completeDay.getFullYear() + ',' + completeDay.getMonth() + ',' + completeDay.getDate();
      completeDayFormat.innerHTML = completeDay;
      //Disabled Days
      ...
      day.appendChild(number);
      day.appendChild(completeDayFormat);
      // If Today..
